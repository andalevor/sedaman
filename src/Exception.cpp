...
public:
    ...
    string join_message(string const& f_n, unsigned long long l_n, string const& msg);

    string d_message;
};

Exception::Impl::Impl(string const& f_n, unsigned long long l_n, string const& msg)
{
...
string Exception::Impl::join_message(string const& f_n, unsigned long long l_n, string const& msg)
{
    ostringstream ss;
